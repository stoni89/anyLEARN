...
var sst = {
  ...
  {
    return db.query('SELECT sst.skillstatus_id, sst.skill_id, sst.status_id, sst.ueberschritten, sst.user_id, s.skill, s.skill, s.lernziel, s.inhalt, s.zeitaufwand, sst.vermittler_id AS verID, ' +
